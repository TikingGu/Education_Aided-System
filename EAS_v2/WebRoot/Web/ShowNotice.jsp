...
<tr>
        ...
        <td><s:property value="#name.content"/></td>
</tr>
</s:iterator>
</table>
</div>
  ...
  bottom:5%;">
   <tr class="odd"> 
        ...
        <s:if test="%{pageBean.currentPage == 1}"></s:if> 
          <s:else>
          <a href="noticeInfoview.action?page=1">首页</a> 
        <td>  <a href="noticeInfoview.action?page=<s:property value="%{pageBean.currentPage-1}"/>" >
          上一页 </a>
         </s:else> 
         </td> 
         <td> 
         <s:if test="%{pageBean.currentPage != pageBean.totaPage}"> 
        <td>  <a  href="noticeInfoview.action?page=<s:property value="%{pageBean.currentPage+1}"/>">下一页</a> 
        <td>  <a  href="noticeInfoview.action?page=<s:property value="pageBean.totaPage"/>">尾页  
          </a> 
         </s:if> 
           </td> 
           <td> 
